...
<body class="bg-dark">
	...
	<div class="row justify-content-center">
		<div class="col-md-6 bg-light p-4 rounded mt-5" style="margin-top: 30px;">
			...
			<form action="" method="post" id="form-data">
				<div id="first">
					<div class="form-group">
						<label for="dob"><b>Period of Assessment:</b><br> From</label>
						<input type="date" name="dob" class="form-control" placeholder="From...">
						<label for="dob">To</label>
						<input type="date" name="dob" class="form-control" placeholder="To...">
					</div>
